'''
Code for creating nested directory structures to avoid having a single
directory with millions of files.
Code for creating nested temp files and dirs.

Configuration: 
    Use NESTED_TMP_DIR, TMPDIR, TEMP, or TMP env var to specify the root temp
    dir.
    Use NESTED_LEVELS to specify how many levels of directory nesting below the
    root you want. This should be an integer between 0 and 20.
      0 = make temp dir and files directly under the root.  e.g
      /tmp/mynestedfile
      1 = make one level of nested dirs between root and tmp files/dirs.  e.g.
      /tmp/a0/mynestedfile
      2 = make 2 levels.  e.g. /tmp/a0/93/mynestedfile
